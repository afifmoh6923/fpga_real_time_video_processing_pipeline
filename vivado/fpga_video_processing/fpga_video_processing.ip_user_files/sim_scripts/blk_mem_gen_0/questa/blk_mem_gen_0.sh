...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/patsn/OneDrive/Documents/fpga-projects/fpga_real_time_video_processing_pipeline/vivado/fpga_video_processing/fpga_video_processing.cache/compile_simlib/questa"
  fi
